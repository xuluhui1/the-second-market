									...
									<!--/sub-heard-part-->
											 <div class="sub-heard-part">
													   <ol class="breadcrumb m-b-0">
															...
															<li><a href="../SearchSuggestionServlet?method=show">网站建议留言管理</a></li>
															<li class="active">回复建议</li>
														</ol>
											</div>	
											<!--/sub-heard-part-->	
											<script>
										...
										<h2 class="inner-tittle">回复留言</h2>
															<div class="graph-form">
																	<div class="form-body">
																		<form action="../SearchSuggestionServlet?method=Areply&sid=<%=sid%>" method="post" onSubmit="return check(A);">
																		<%
																			String id = request.getParameter("id");
																			int lid = Integer.parseInt(id);
																		%> 
																			<div class="form-group"> 
																				回复接收人:<input value="<%=lid%>" type="hidden" class="form-control" name="receiverid"><%=lid%>
																				回复:<br><input type="text" name="message" id="A">  
																			</div>
