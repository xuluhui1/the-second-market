					...
					<!-- //header-ends -->
							<!--//outer-wp-->
									...
									<!--/sub-heard-part-->
										...
										<h2 class="inner-tittle">添加新的院级</h2>
															<div class="graph-form">
																	<div class="form-body">
																		<form action="../SchoolDepartServlet?method=insertDepart" method="post" onSubmit="return check(A);"> 
																			<div class="form-group"> 
																				<label>请输入新的院级名称</label> 
																				<input type="text" class="form-control" name="departname" id="A"> 
																			</div>
