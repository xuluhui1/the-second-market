					...
					<!-- //header-ends -->
							<!--//outer-wp-->
									...
									<!--/sub-heard-part-->
										...
										<h2 class="inner-tittle">添加新的学校 </h2>
															<div class="graph-form">
																	<div class="form-body">
																		<form action="../SchoolDepartServlet?method=insertSchool" method="post" onSubmit="return check(A);"> 
																			<div class="form-group"> 
																				<label>请输入新的学校名称</label> 
																				<input type="text" class="form-control" name="schoolname" id="A"> 
																			</div>
