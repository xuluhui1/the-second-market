											...
											<!--/sub-heard-part-->
											 <div class="sub-heard-part">
													   <ol class="breadcrumb m-b-0">
															...
															<li class="active">商品留言管理</li>
														</ol>
											</div>	
											<form action="../SearchServlet?method=search" method="post">
											...
											<!--/sub-heard-part-->	
												<!--/forms-->
													<div class="forms-main">
														<h2 class="inner-tittle">商品留言管理</h2>
												<div class="graph">
														<div class="tables">	
																<table class="table">
																	<thead>
																	...
																	<tb>
																	<c:forEach items="${requestScope.bbsInfoAll}" var="bbs">
																		<tr>
																			<td>${bbs.bbsid}</td>
																			<td>${bbs.senddate}</td>
																			<td>${bbs.senderid}</td>
																			<td>${bbs.receiverid}</td>
																			<td>${bbs.goodsid}</td>
																			<td>${bbs.message}</td>
																			<td><a href="SearchServlet?method=delete&id=${bbs.id}">删除</a></td>
																		</tr>
																	</c:forEach>
																	</tbody>
																</table>
