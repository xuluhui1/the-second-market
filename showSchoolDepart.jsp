									...
									<!--/sub-heard-part-->
											 <div class="sub-heard-part">
													   <ol class="breadcrumb m-b-0">
															...
															<li class="active">查看已有学校与院级</li>
														</ol>
											</div>	
											<div class="graph-visual tables-main">
											<h3 class="inner-tittle two">学校信息</h3>
													<div class="graph">
														<div class="tables">
																<table class="table table-bordered"> 
																	...
																	<tbody> 
																		<c:forEach items="${requestScope.schoolInfoAll}" var="school">
																			<tr>
													...
													<h3 class="inner-tittle two">院级信息</h3>
													<div class="graph">
														<div class="tables">
																<table class="table table-bordered"> 
																	<thead> 
																	...
																	<tbody> 
																		<c:forEach items="${requestScope.departInfoAll}" var="depart">
																			<tr>
