											...
											<!--/sub-heard-part-->
											 <div class="sub-heard-part">
													   <ol class="breadcrumb m-b-0">
															...
															<li class="active">网站建议留言管理</li>
														</ol>
											</div>	
											<form action="../SearchSuggestionServlet?method=search" method="post">
											...
											<!--/sub-heard-part-->	
												<!--/forms-->
													<div class="forms-main">
														<h2 class="inner-tittle">网站建议留言管理</h2>
												<div class="graph">
														<div class="tables">	
																<table class="table">
																	<thead>
																	...
																	<tbody>
																	<c:forEach items="${requestScope.suggestionInfoAll}" var="suggestion">
																			<tr>
																				<td>${suggestion.suggestionid}</td>
																				<td>${suggestion.talktime}</td>
																				<td>${suggestion.senderid}</td>
																				<td>${suggestion.receiverid}</td>
																				<td>${suggestion.suggestioncontent}</td>
																				<td><a href="areply.jsp?sid=${suggestion.id}&id=${suggestion.sid}">${suggestion.suggestionstatus}</a></td>
																	</tr>
																	</c:forEach>
																	</tbody>
																</table>
