					...
					<!-- //header-ends -->
							<!--//outer-wp-->
									...
									<!--/sub-heard-part-->
										...
										<h2 class="inner-tittle">添加新的商品类型 </h2>
															<div class="graph-form">
																	<div class="form-body">
																		<form action="../GoodClassServlet?method=insert" method="post" onSubmit="return check(A);"> 
																			<div class="form-group"> 
																				<label>请输入商品类型名</label> 
